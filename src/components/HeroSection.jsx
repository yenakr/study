...
export default function HeroSection({ scrollToSection, openPolicyPreview }) {
  ...
  return (
    <section id="home" className="relative pt-28 pb-16 md:pt-36 md:pb-20 bg-gradient-to-b from-navy-900 via-navy-800 to-slate-900 text-white overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* CTAs */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 mb-16">
            <button
              onClick={() => scrollToSection('problem')}
              className="inline-flex items-center justify-center px-6 py-3.5 rounded-lg bg-brand-blue hover:bg-blue-600 text-white font-semibold text-base transition-colors shadow-md"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center px-6 py-3.5 rounded-lg bg-navy-800 hover:bg-navy-700 border border-slate-700 text-white font-semibold text-base transition-colors"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center px-6 py-3.5 rounded-lg bg-white/10 hover:bg-white/15 text-white border border-white/20 font-semibold text-base transition-colors"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {problemCards.map((card, idx) => {
            ...
            return (
              <div 
                key={idx}
                className="bg-navy-800/90 rounded-xl p-6 border border-slate-700/80 shadow-md text-left"
              >
                <div className="w-10 h-10 rounded-lg bg-brand-blue/20 flex items-center justify-center mb-4 text-brand-lightblue">
